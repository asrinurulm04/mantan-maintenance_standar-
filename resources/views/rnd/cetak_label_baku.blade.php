...
<div class="content-wrapper">
  ...
  <div class="card">
    <div class="card-body">
		<form class="form-horizontal form-label-left" method="POST" action="{{route('cetak_idBB')}}" novalidate>
			<a href="{{route('cetakBB')}}" class="btn btn-success btn-sm"><li class="fa fa-table"></li> Cetak semua standar</a>&nbsp&nbsp
