          ...
          <div class="card-body">
            ...
            @endif
						...
						<div class="card-header flat bg-secondary text-center">
							<h5 class="">Input WIP Baru</h5>
						</div>
						<table class="table table-bordered text-center">
              <form action="/rnd/input/wip/baru/store" method="post">
              {{csrf_field()}}
              ...
              <tr>
                <td>Pembuat</td>
                <td><input type="text" name="pembuat" value="{{Auth::user()->nama}}" class="form-control" tooltip="Pembuat" required> </td>
              </tr>
              <tr>
