...
class cetakBBController extends Controller
{
    public function cetak_allBB(){
        ...
        $data=standar::where('freeze','=','N')->where('jenis_item_id','=','2')->get();
        $no=1;
        foreach($data as $_data){
            ...
            if($_data['tgl_terima']=="0000-00-00"){$_data['tgl_terima']="-";}
            else{$_data['tgl_terima']=date('d-M-Y', strtotime($_data['tgl_terima']));}
            ...
            $styleArray = array(
                ...
                if($no%4==1){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ->setCellValue('A'.$baris, 'Standar Bahan Baku (SBB)');
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ...
                                ->setCellValue('C'.$baris, ':')
                                ->setCellValue('D'.$baris, $_data['tgl_terima']);
                ...
                if($no%4==2){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ->setCellValue('F'.$baris, 'Standar Bahan Baku (SBB)');
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ...
                                ->setCellValue('H'.$baris, ':')
                                ->setCellValue('I'.$baris, $_data['tgl_terima']);
                ...
                if($no%4==3){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ->setCellValue('K'.$baris, 'Standar Bahan Baku (SBB)');
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ...
                                ->setCellValue('M'.$baris, ':')
                                ->setCellValue('N'.$baris, $_data['tgl_terima']);
                ...
                if($no%4==0){
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                                ...
                                ->setCellValue('R'.$baris, ':')
                                ->setCellValue('S'.$baris, $_data['tgl_terima']);
        ...
        header('Content-Disposition: attachment;filename="LABEL_STANDAR_BB_ALL_'.$skrg.'.xls"'); 
    ...
    public function cetak_idBB(Request $request){
        $objPHPExcel = new Spreadsheet();
        ...
        for ($i = 0; $i < count($ids); $i++)
            {
                //BAGIAN ISI
                $data=standar::where('id_standar','=',$ids[$i])->get();
                foreach($data as $_data){
            ...
            header('Content-Type: application/vnd.ms-excel'); 
            header('Content-Disposition: attachment;filename="LABEL_STANDAR_BB_'.$skrg.'.xls"'); 
